<?php
  ...
  function getTitle($nfile){
     ...
     */
        ...
        $sql = "SELECT nome as title  FROM sidebar WHERE funzione LIKE '$nfile%'";
  ...
  function getSubMenu1($subParMenu){
     ...
     */
        ...
        $sql = "SELECT * FROM sidebar WHERE menu = '$subParMenu' AND sub2 = 0 ORDER BY posizione ASC";
